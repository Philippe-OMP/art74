...
the bisectors of disk-integrated profiles using the inferred image of Betelgeuse for the date of XXXX. The square root gradient law
...
though often it  presents a normal C-shape. But when isolated in separate layers, the bisectors of lines forming in either layer 
...
behave so differently is an open question. The apparent existance of cyclical Decin stages \citep{XXX} supports the idea that these larger or smaller velocity 
